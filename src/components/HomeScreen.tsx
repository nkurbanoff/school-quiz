		...
		<div className="min-h-screen bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-900 dark:to-slate-800 p-6 transition-colors">
			...
			<div className="max-w-4xl mx-auto">
				<div className="text-center mb-8">
					<h1 className="text-4xl font-bold text-slate-800 dark:text-slate-100 mb-2">School Quiz</h1>
					<p className="text-slate-600 dark:text-slate-400">Выбери предмет для прохождения викторины</p>
