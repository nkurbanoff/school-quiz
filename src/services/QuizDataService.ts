...
export class QuizDataService {
	private static readonly STORAGE_KEY = 'schoolQuizData';
	private static readonly VERSION_KEY = 'schoolQuizVersion';
	private static readonly CATEGORY_VERSION_PREFIX = 'schoolQuizCategoryVersion_';

	// Базовый URL до raw файлов в GitHub (индивидуальные файлы по категориям)
	private static readonly BASE_URL =
		'https://raw.githubusercontent.com/nkurbanoff/school-quiz/main/public/data';
